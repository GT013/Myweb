...
button6.className = "btn btn-light";
button6.innerHTML = "7";
button6.type = "button";
button6.value = "7";
button6.id = "btn7";
...
button7.className = "btn btn-dark";
button7.innerHTML = "8";
button7.type = "button";
button7.value = "8";
button7.id = "btn8";
...
button8.className = "btn btn-light";
button8.innerHTML = "";
button8.type = "button";
button8.value = "";
button8.id = "btn9";
...
btnrnd.className = "btn btn-success";
...
again.onclick = reset;
again.className = "btn btn-warning";
